...
@section('page_title', 'Pengumuman Admin')
@section('page_subtitle', 'Buat informasi terbaru yang akan dilihat siswa di dashboard')
        ...
        <div class="card-body">
            <form method="post" action="{{ route('admin.announcements.store') }}" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="Contoh: Jadwal latihan berubah" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check mt-2">
                        <input class="form-check-input" type="checkbox" name="is_active" value="1" id="adminAnnouncementActive" checked>
                        <label class="form-check-label" for="adminAnnouncementActive">Tampilkan ke siswa</label>
                    </div>
                </div>
                <div class="col-12">
                    <label class="form-label">Isi Pengumuman</label>
                    <textarea name="content" class="form-control" rows="4" placeholder="Tulis informasi penting untuk siswa" required></textarea>
                </div>
                <div class="col-12">
                ...
                <table class="table table-striped mb-0">
                    ...
                    @forelse($announcements as $announcement)
                        <tr>
                            ...
                            <td>{{ $announcement->extracurricular->name ?? 'Semua ekstrakurikuler' }}</td>
