        ...
        <div class="card-body toolbar-card">
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
                <div>
                    ...
                    <p class="toolbar-hint mb-0">Cari berdasarkan nama, NIS, kelas, atau kegiatan, lalu saring per kelas, kategori, kegiatan yang diikuti, jenis kelamin, dan status agar verifikasi lebih cepat.</p>
                </div>
            ...
            <form class="toolbar-grid">
                ...
                <div class="toolbar-col-2">
                    <a href="{{ route('admin.registrations.index') }}" class="btn btn-outline-secondary w-100"><i class="bi bi-arrow-repeat"></i>Reset</a>
                </div>
            </form>
        </div>
    </div>
