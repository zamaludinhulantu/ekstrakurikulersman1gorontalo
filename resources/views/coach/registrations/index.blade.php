...
@section('page_subtitle', 'Periksa pendaftar hanya untuk ekstrakurikuler yang Anda bina')
    ...
    <div class="card mb-3">
        <div class="card-body toolbar-card">
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
                <div>
                    <h2 class="h5 mb-1">Filter Pendaftar</h2>
                    <p class="toolbar-hint mb-0">Tampilkan hanya siswa pendaftar pada ekskul binaan Anda.</p>
                </div>
            </div>
                ...
                <table class="table table-striped mb-0">
                    ...
                    @forelse($registrations as $registration)
                        <tr>
                            ...
                            <td>
                                <form method="post" action="{{ route('coach.registrations.update-status', $registration) }}" class="row g-2">
                                    @csrf
                                    @method('patch')
                                    <div class="col-12">
            ...
            <div class="mobile-stack-table p-3">
                @forelse($registrations as $registration)
                    <div class="mobile-data-card">
                        ...
                        <form method="post" action="{{ route('coach.registrations.update-status', $registration) }}">
                            @csrf
                            @method('patch')
                            <div class="mb-2">
