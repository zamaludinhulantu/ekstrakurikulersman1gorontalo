        ...
        <div class="card-body toolbar-card">
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-3">
                <div>
                    ...
                    <p class="toolbar-hint mb-0">Cari berdasarkan nama atau NIS, lalu saring per status dan ekstrakurikuler binaan agar verifikasi lebih cepat.</p>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end table-action-col">
                                <div class="table-inline-actions table-inline-actions--compact justify-content-end">
                                    <a
                                        href="{{ route('coach.registrations.show', $registration) }}"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-compact">
                                            ...
                                            @if(in_array($displayStatus, ['waiting_test', 'scheduled_test', 'approved'], true) && $registration->willing_to_take_test)
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('coach.talent-tests.index', ['extracurricular_id' => $registration->extracurricular_id]) }}">
                ...
                @forelse($registrations as $registration)
                    ...
                    <div class="mobile-data-card">
                        ...
                        <div class="table-inline-actions table-inline-actions--compact">
                            <a href="{{ route('coach.registrations.show', $registration) }}" class="btn btn-sm btn-outline-primary action-button-icon" data-bs-toggle="tooltip" data-bs-title="Lihat detail pendaftaran"><i class="bi bi-eye"></i></a>
                            <div class="dropdown flex-grow-0">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-compact">
                                    ...
                                    @if(in_array($displayStatus, ['waiting_test', 'scheduled_test', 'approved'], true) && $registration->willing_to_take_test)
                                        <li><a class="dropdown-item" href="{{ route('coach.talent-tests.index', ['extracurricular_id' => $registration->extracurricular_id]) }}"><i class="bi bi-clipboard2-pulse me-2"></i>{{ $displayStatus === 'scheduled_test' ? 'Kelola Tes' : 'Jadwalkan Tes' }}</a></li>
                                    @endif
