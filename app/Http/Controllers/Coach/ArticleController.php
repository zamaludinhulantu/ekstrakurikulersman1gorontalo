...
class ArticleController extends Controller
{
    public function index(Request $request): View
    {
        ...
        $managedExtracurriculars = $coach->extracurriculars()->orderBy('name')->get();
        $allowedIds = $managedExtracurriculars->pluck('id')->map(fn ($id) => (string) $id)->all();
        ...
        if ($extracurricularId !== '' && ! in_array($extracurricularId, $allowedIds, true)) {
            $extracurricularId = '';
        }
        ...
        $statistics = $this->buildStatistics(
            Article::query()->where('published_by', auth()->id())
        );
        ...
        return view('coach.articles.index', [
            ...
            'extracurriculars' => $managedExtracurriculars,
            'search' => $search,
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $article = Article::query()->create(
            $this->validatedPayload($request, $coach->extracurriculars()->pluck('extracurriculars.id')->all())
        );
    ...
    {
        $this->authorize('manageByCoach', $article);
        $coach = auth()->user()->coach;
    ...
    public function update(Request $request, Article $article): RedirectResponse
    {
        ...
        $article->update(
            $this->validatedPayload($request, $coach->extracurriculars()->pluck('extracurriculars.id')->all(), $article)
        );
    ...
    public function publish(Article $article): RedirectResponse
    {
        ...
        return redirect()->route('coach.articles.index')->with('success', 'Artikel berhasil dipublikasikan.');
    }
    ...
    public function unpublish(Article $article): RedirectResponse
    {
        ...
        return redirect()->route('coach.articles.index')->with('success', 'Publikasi artikel berhasil ditarik ke draft.');
    }
    ...
    public function archive(Article $article): RedirectResponse
    {
        ...
        return redirect()->route('coach.articles.index')->with('success', 'Artikel berhasil diarsipkan.');
    }
    ...
    public function destroy(Article $article): RedirectResponse
    {
        ...
        return redirect()->route('coach.articles.index')->with('success', 'Berita / artikel berhasil dihapus.');
    }
    ...
    private function redirectAfterSave(Request $request, Article $article, bool $created): RedirectResponse
    {
        ...
        if ($submitAction === 'publish') {
            ...
            return redirect()
                ->route('coach.articles.index', ['tab' => 'list'])
    ...
    private function validatedPayload(Request $request, array $allowedExtracurricularIds, ?Article $article = null): array
    {
        $submitAction = $request->input('submit_action', 'draft');
        ...
        $validated = $request->validate([
            ...
            'extracurricular_id' => ['required', Rule::in(array_map('strval', $allowedExtracurricularIds))],
